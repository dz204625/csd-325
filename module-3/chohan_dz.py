...
dice total to an even (cho) or odd (han) number. If the user gets a 2 or a 7 on a dice roll, they get a 10 mon bonus.
''')
...
while True:  # Main game loop.
    ...
    if playerWon:
        ...
        if dice1 + dice2 == 2 or dice1 + dice2 == 7:
            pot = pot + 10
            print("The total roll: ", dice1 + dice2, "and you won 10 mon bonus.")
        print('You won! You take', pot, 'mon.')
        purse = purse + pot  # Add the pot from player's purse.
        print('The house collects a', pot // 12, 'mon fee.')
        purse = purse - (pot // 12)  #Change the percentage that goes to the house to 12 percent instead of 10 percent
    else:
